...
- Multithreading:
  ...
  - [Effil](https://github.com/effil/effil) - Manageable threads with independent Lua states. Data exchange based on thread safe tables + metatable and FIFO channels.
